...
export const MypagePage = () => {
  ...
  useEffect(() => {
    ...
    if (memberId && memberId !== "null" && token) {
      ...
      console.log(
        "⏳ 아직 memberId나 token이 준비되지 않아 요청을 대기합니다.",
      );
    }
  }, [memberId, token]);
  console.log(path);
    ...
    <div className="mypage">
      <div className={styles.mypage_wrap}>
        <div className={styles.sidebar_wrap}>
          <div>
            <div className={styles.mypagetxt}>마이페이지</div>
        ...
        <div className={styles.content_wrap}>
          ...
          {path === "myinfo/changeEmail" && (
            <ChangeEmail memberInfo={memberInfo} />
          )}
        </div>
      </div>
    </div>
...
export const Myinfo = ({ memberInfo }) => {
  ...
  const profileImgSrc =
    memberThumb && memberThumb !== defaultImg ? `${memberThumb}` : defaultImg;
  const changeThumb = () => {
      ...
      <div className={styles.content_menu_wrap}>
          ...
          <div>
            <div className={styles.info_email}>
              ...
              <div>
                <button
                  ...
                  onClick={() =>
                    (window.location.href = "/mypage/myinfo/changeEmail")
                  }
                >
                  이메일 변경
                </button>
            ...
            <div className={styles.info_pwchange}>
              ...
              <button
                ...
                className={styles.submit}
                onClick={() =>
                  (window.location.href = "/mypage/myinfo/changePw")
                }
              >
                비밀번호 변경
              </button>
        ...
        <div className={styles.info_3line}>
          ...
          <div className={styles.info_delete}>
            ...
            <div>
              <p>
                맛맛곳곳에 저장된 기록들이 전부 삭제되며 해당 계정으로 다시
                로그인 할 수 없습니다.
              </p>
              <p>동의하십니까?</p>
            </div>
            <div>
              <button type="submit" className={styles.submit_d}>
                회원 탈퇴
              </button>
            </div>
          </div>
...
export const Myreview = ({ memberInfo }) => {
  return (
    <>
      <div
        className={`${styles.content_menu_wrap} ${styles.content_myreview_wrap}`}
      >
...
export const Zzim = ({ memberInfo }) => {
  return (
    <>
      <div
        className={`${styles.content_menu_wrap} ${styles.content_zzim_wrap}`}
      >
        <div className={styles.posts_bar}>
          <div>
            <p>전체 선택</p>
...
export const Matzip = ({ memberInfo }) => {
  return (
    <>
      <div
        className={`${styles.content_menu_wrap} ${styles.content_tuar_wrap}`}
      >
        <div className={styles.posts_bar}>
          <div>
            <p>전체 선택</p>
...
export const Likeposts = ({ memberInfo }) => {
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_BACKSERVER}/boards/${memberno}/mylike`, {
        params: {
          page,
          size,
          order,
  ...
  return (
    <>
      <div
        className={`${styles.content_menu_wrap} ${styles.content_likepost_wrap}`}
      >
        <div className={styles.posts_bar}>
          <div>
            <p>전체 선택</p>
...
export const Myposts = ({ memberInfo }) => {
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_BACKSERVER}/boards/${memberno}/my`, {
        params: {
          page,
          size,
          order,
  ...
  return (
    <>
      <div
        className={`${styles.content_menu_wrap} ${styles.content_mypost_wrap}`}
      >
        <div className={styles.posts_bar}>
          <div>
            <p>전체 선택</p>
...
export const Reportposts = ({ memberInfo }) => {
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_BACKSERVER}/boards/${memberno}/myreport`, {
        params: {
          page,
          size,
          order,
...
export const ChangePw = () => {
  ...
  const pwChange = () => {
    ...
    axios
      .post(`${import.meta.env.VITE_BACKSERVER}/members/pwMember`, pwMember)
      .then((res) => {
        console.log(res);
        Swal.mixin({
          toast: true,
  ...
  return (
    <>
      <div className={styles.content_changePw_wrap}>
        ...
        <button
          type="submit"
          className={`${styles.submit} ${styles.submit_chg}`}
          onClick={pwChange}
        >
          비밀번호 변경
        </button>
...
export const ChangeEmail = ({ memberInfo }) => {
  ...
  const sendMail = () => {
    ...
    setMailAuth(1);
    axios
      .post(`${import.meta.env.VITE_BACKSERVER}/members/email-emailchange`, {
  ...
  const updateEmail = () => {
    axios
      .post(
        `${import.meta.env.VITE_BACKSERVER}/members/changeEmail`,
        mailMember,
      )
      .then((res) => {
        console.log(res);
